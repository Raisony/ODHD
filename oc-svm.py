...
def main(data, seed, kernel):
    ...
    clf = OneClassSVM(kernel = kernel, gamma = 1e-7).fit(Xtrain)
    testLabels = ytest
...
if __name__ == '__main__':
    ...
    parser.add_argument('--kernel', metavar='N', type=str)

    args = parser.parse_args()
    main(args.data, args.seed, args.kernel)
